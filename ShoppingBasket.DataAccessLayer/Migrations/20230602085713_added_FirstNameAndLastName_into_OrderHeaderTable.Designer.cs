...
namespace ShoppingBasket.DataAccessLayer.Migrations
{
    ...
    [Migration("20230602085713_added_FirstNameAndLastName_into_OrderHeaderTable")]
    partial class added_FirstNameAndLastName_into_OrderHeaderTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingBasket.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShoppingBasket.Models.Coupon", b =>
                {
                    ...
                    b.Property<double?>("MaxOrderedAmount")
                        .HasColumnType("float");

                    b.Property<double>("MinOrderedAmount")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ShoppingBasket.Models.Product", b =>
                {
                    ...
                    b.Property<string>("ProductImage_2")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ShoppingBasket.Models.Cart", b =>
                {
                    b.HasOne("ShoppingBasket.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingBasket.Models.OrderDetail", b =>
                {
                    b.HasOne("ShoppingBasket.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingBasket.Models.Product", b =>
                {
                    b.HasOne("ShoppingBasket.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingBasket.Models.Stock", b =>
                {
                    b.HasOne("ShoppingBasket.Models.Product", "Product")
                        .WithOne("Stock")
                        .HasForeignKey("ShoppingBasket.Models.Stock", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShoppingBasket.Models.Wishlist", b =>
                {
                    ...
                    b.HasOne("ShoppingBasket.Models.Product", "Product")
                        .WithOne("Wishlist")
                        .HasForeignKey("ShoppingBasket.Models.Wishlist", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
